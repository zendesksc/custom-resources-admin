...
# Remove -e files generated by sed
rm dist/assets/index.html-e dist/manifest.json-e
...
echo "Custom Resources Admin app has been compiled to ~/Desktop/Custom Resources Admin.zip"